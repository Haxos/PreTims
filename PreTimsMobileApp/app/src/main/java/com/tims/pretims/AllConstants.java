...
public class AllConstants {
    ...
    public static final int DATABASE_SQLITE_VERSION = 2;
    ...
    //the route for updating a dish will be use for storing a reservation
    public static final String DELETE_RESERVATION = DOMAIN_NAME+"dish/0";
