...
import com.tims.pretims.DishItemFragment.OnListFragmentInteractionListener;
 ...
 */
public class DishItemRecyclerViewAdapter extends RecyclerView.Adapter<DishItemRecyclerViewAdapter.ViewHolder> {

    private final List<Dish> dishies;
    private final OnListFragmentInteractionListener mListener;

    public DishItemRecyclerViewAdapter(List<Dish> items, OnListFragmentInteractionListener listener) {
        dishies = items;
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_dish_item, parent, false);
